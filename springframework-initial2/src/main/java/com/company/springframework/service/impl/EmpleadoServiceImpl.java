...
public class EmpleadoServiceImpl implements EmpleadoService {
    ...
    public List<EmpleadoDescripcionDTO> getEmpleadosConDescripcion() {
    ...
    @Override
    public List<EmpleadoDescripcionDTO> listarTodosLosEmpleadosDTO() {
        Iterable<Empleado> empleados = empleadoRepository.findAll();
        List<EmpleadoDescripcionDTO> empleadosDTO = new ArrayList<>();
